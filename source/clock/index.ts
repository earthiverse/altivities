const CLOCK_MINUTE = document.getElementById("clock_minute") as HTMLDivElement
const CLOCK_HOUR = document.getElementById("clock_hour") as HTMLDivElement
...
function limitClock(element: HTMLInputElement) {
...
function checkTime() {
    ...
    if (isNaN(check_hour)) {
        // They didn't enter anything in the hour spot
...
function showResponseImage(src: string, pos: "left" | "right") {
